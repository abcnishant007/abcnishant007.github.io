...
I study how urban traffic congestion can be predicted, explained, and mitigated using machine learning, simulation, and open data.

I am a transportation researcher working on urban traffic congestion as a data-driven, complex-systems problem. My research focuses on scalable and interpretable congestion prediction, model complexity, road-network-based explanations, and the resilience of interconnected infrastructures such as transport and EV charging systems.
